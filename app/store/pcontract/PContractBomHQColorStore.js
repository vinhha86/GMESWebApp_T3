Ext.define('GSmartApp.store.pcontract.PContractBomHQColorStore', {
	extend: 'Ext.data.Store',
	alias: 'store.PContractBomHQColorStore',
	storeId: 'PContractBomHQColorStore',
	model: 'GSmartApp.model.pcontract.PContractBOMHQColorModel',
	...
	loadStoreColor: function (pcontractid_link, productid_link, colorid_link) {
		...
		this.setProxy({
			...
			url: config.getAppBaseUrl() + '/api/v1/pcontractproductbomhq/getlist_pcontract_productbomcolor',
			paramsAsJson: true,
			extraParams: params,
			noCache: false,
			headers: {
	...
	load_bom_by_product: function (pcontractid_link, productid_link) {
		...
		this.setProxy({
			...
			url: config.getAppBaseUrl() + '/api/v1/pcontractproductbomhq/getbom_by_product',
			paramsAsJson: true,
			timeout: 120 * 1000,
			extraParams: params,
			noCache: false,
	...
	load_bom_by_product_multithread: function (pcontractid_link, productid_link) {
		...
		this.setProxy({
			...
			url: config.getAppBaseUrl() + '/api/v1/pcontractproductbomhq/getbom_by_product_multithread',
			paramsAsJson: true,
			extraParams: params,
			timeout: 120 * 1000,
			noCache: false,
