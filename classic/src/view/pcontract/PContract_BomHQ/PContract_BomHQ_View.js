Ext.define('GSmartApp.view.pcontract.PContract_BomHQ_View', {
    extend: 'Ext.grid.Panel',
    xtype: 'PContract_BomHQ_View',
    id: 'PContract_BomHQ_View',
    controller: 'PContract_BomHQ_ViewController',
    itemId: 'PContract_BomHQ_View',
    bind: {
        store: '{PContractBomHQColorStore}'
    },
    features: [{
        ftype: 'grouping',
        groupHeaderTpl: '{name}'
    ...
    columns: [{
        ...
        align: 'center',
        items: [{
            itemId: 'btnDeleteMaterial_BomHQ',
