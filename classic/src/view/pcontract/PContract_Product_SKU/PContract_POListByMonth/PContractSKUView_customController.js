Ext.define('GSmartApp.view.pcontract.PContract_Product_SKU.PContract_POListByMonth.PContractSKUView_customController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.PContractSKUView_customController',
    init: function () {

    },
    listen: {
        controller: {
            'PContract_POList_customController':{
                'selectPO_line': 'onSelectPO_line'
            }
        }
    },
    control: {
    ...
    onSelectPO_line: function(record){
          var view = this.getView();
          var cmbSanPham =view.down('#cmbSanPham');
